package com.cg.socialnetwork.service.jwt;
...
public class JwtService {
    private static final String SECRET_KEY = "GoiTenToiNheBanThanHoiCoToiLuonCungChiaSotDeRoiTaLaiCoThemNiemTin3423423423423423423423423";
    public static final long JWT_TOKEN_VALIDITY = 1000L;
    private static final Logger logger = LoggerFactory.getLogger(com.cg.socialnetwork.service.jwt.JwtService.class.getName());
